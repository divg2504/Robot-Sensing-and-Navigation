...
import math
import utm
from rtk_gnss_driver.msg import gnss_msg
...
def collect_GPS_data(port):	
	...
	required_value = 'GNGGA'
	global timestamp, lat_v, lat_d, long_v, long_d, altitude, fix_quality
...
def GPS_to_UTM():
	global easting,northing,zone,letter, lat_v, long_v, lat_d, long_d
	if lat_d == 'S':
		lat_v = -1*lat_v
	if long_d == 'W':
		long_v = -1*long_v
...
if __name__ == "__main__":
	...
	gps_publisher = rospy.Publisher('/gps', gnss_msg, queue_size = 10)
